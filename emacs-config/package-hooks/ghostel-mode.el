...
(defun lx/ghostel-mode--configure ()
  ...
  (defun ghostel-send-meta-h () (interactive) (ghostel-send-key "h" "meta"))
...
PROCESS is the shell process, EVENT describes the state change."
  ...
  (define-key ghostel-mode-map (kbd "M-h") #'ghostel-send-meta-h)
  ...
  (define-key ghostel-semi-char-mode-map (kbd "M-h") #'ghostel-send-meta-h)
