(with-eval-after-load 'xwidget
  ...
  (define-key xwidget-webkit-mode-map (kbd "R") 'xwwp-reader-toggle)
  ...
  (evilified-state-evilify xwidget-webkit-mode xwidget-webkit-mode-map (kbd "R") 'xwwp-reader-toggle)
