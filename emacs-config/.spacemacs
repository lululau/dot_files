...
It should only modify the values of Spacemacs settings."
 ...
 (setq-default
   ...
   dotspacemacs-elpa-subdirectory "master-config"
...
(quote
 ...
 '(vterm-eval-cmds (quote (("find-file" find-file) ("message" message) ("vterm-clear-scrollback" vterm-clear-scrollback) ("lx/run-in-vterm/set-green-box-cursor" lx/run-in-vterm/set-green-box-cursor) ("lx/run-in-vterm/set-blue-bar-cursor" lx/run-in-vterm/set-blue-bar-cursor) ("update-pwd" lx/run-in-vterm/set-default-directory) ("find-remote-file" lx/run-in-vterm/find-remote-file))))
