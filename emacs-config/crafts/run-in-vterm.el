...
(defvar lx/run-shell-in-vterm-keymap (let ((map (make-sparse-keymap)))
                                       ...
                                       (define-key map (kbd "s-1") #'(lambda () (interactive) (vterm-send-C-j) (vterm-send-string "1")))
                                       (define-key map (kbd "s-2") #'(lambda () (interactive) (vterm-send-C-j) (vterm-send-string "2")))
                                       (define-key map (kbd "s-3") #'(lambda () (interactive) (vterm-send-C-j) (vterm-send-string "3")))
                                       (define-key map (kbd "s-4") #'(lambda () (interactive) (vterm-send-C-j) (vterm-send-string "4")))
                                       (define-key map (kbd "s-5") #'(lambda () (interactive) (vterm-send-C-j) (vterm-send-string "5")))
                                       (define-key map (kbd "s-6") #'(lambda () (interactive) (vterm-send-C-j) (vterm-send-string "6")))
                                       (define-key map (kbd "M-1") #'(lambda () (interactive) (vterm-send-C-j) (vterm-send-string "7")))
                                       (define-key map (kbd "M-2") #'(lambda () (interactive) (vterm-send-C-j) (vterm-send-string "8")))
                                       (define-key map (kbd "M-3") #'(lambda () (interactive) (vterm-send-C-j) (vterm-send-string "9")))
                                       (define-key map (kbd "M-4") #'(lambda () (interactive) (vterm-send-C-j) (vterm-send-string "0")))
                                       map))
