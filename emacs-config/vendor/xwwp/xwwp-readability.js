 ...
 *
 * Modified to be fit into xwwp package for Emacs
 *
 * Copyright (c) 2010 Arc90 Inc
 * Modifications Copyright (c) 2020 K. Scarlet <qhong@mit.edu>
    ...
    **/
    ...
    prepDocument: function () {
        ...
        for (var st=0;st < styleTags.length; st+=1) {
            if(!(styleTags[st].id === "__xwidget_plus_readability_style"))
