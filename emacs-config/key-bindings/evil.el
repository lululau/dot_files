...
(define-key evil-normal-state-map "s" #'lx/evil-substitute-and-indent)
...
(define-key evil-normal-state-map "za" #'lx/evil-smart-toggle-fold)
(define-key evil-normal-state-map "gf" #'lx/evil-smart-goto-file)
...
(define-key evil-normal-state-map (kbd "RET") #'lx/evil-insert-newline-below)
(define-key evil-motion-state-map (kbd "RET") #'lx/evil-insert-newline-below)
