...
(define-key evil-motion-state-map (kbd "<C-return>") #'jump-to-definition-of-symbol-at-point)
...
(define-key evil-emacs-state-map (kbd "<C-return>") #'jump-to-definition-of-symbol-at-point)
