...
(define-key evil-motion-state-map (kbd "<s-return>") #'(lambda () (interactive) (call-interactively (if (eq major-mode 'org-mode) 'org-insert-heading-respect-content 'jump-to-definition-of-symbol-at-point-other-window))))
...
(define-key evil-emacs-state-map (kbd "<s-return>") #'(lambda () (interactive) (call-interactively (if (eq major-mode 'org-mode) 'org-insert-heading-respect-content 'jump-to-definition-of-symbol-at-point-other-window))))
