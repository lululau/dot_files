...
(global-set-key (kbd "s-;") #'(lambda () (interactive) (lx/run-in-zsh-ghostel "tmux-attach-or-create emacs" "*tmux-emacs*")))
...
(global-set-key (kbd "s-'") #'(lambda () (interactive) (lx/run-in-zsh-ghostel "tmux-attach-or-create emacs" "*tmux-emacs*" nil 'popup)))
(global-set-key (kbd "s-\"") #'(lambda () (interactive)
...
(global-set-key (kbd "s-r s-;") #'(lambda () (interactive) (lx/run-in-pry-ghostel (cdr (assoc "pry" inf-ruby-implementations)) "*pry*")))
(global-set-key (kbd "s-[") 'previous-buffer)
(global-set-key (kbd "s-]") 'next-buffer)
(global-set-key (kbd "s-/") 'evilnc-comment-or-uncomment-lines)
(global-set-key (kbd "s-\\") 'lx/switch-to-previous-perp)
(global-set-key (kbd "s-M-'") #'(lambda () (interactive) (call-interactively 'split-window-right-and-focus) (ghostel)))
...
(global-set-key (kbd "s-r 1") #'(lambda () (interactive) (helm-zsh-ghostel-ssh-run "jicai.prod1")))
(global-set-key (kbd "s-r 2") #'(lambda () (interactive) (helm-zsh-ghostel-ssh-run "jicai.prod2")))
(global-set-key (kbd "s-r 3") #'(lambda () (interactive) (helm-zsh-ghostel-ssh-run "jicai.prod3")))
(global-set-key (kbd "s-r 8") #'(lambda () (interactive) (helm-zsh-ghostel-ssh-run "jicai.uat")))
(global-set-key (kbd "s-r 9") #'(lambda () (interactive) (helm-zsh-ghostel-ssh-run "jicai.dev")))
(global-set-key (kbd "s-r l 1") #'(lambda () (interactive) (helm-ghostel-vrl-run-auto-function "jicai-api-open")))
(global-set-key (kbd "s-r l 2") #'(lambda () (interactive) (helm-ghostel-vrl-run-auto-function "jicai-dev")))
(global-set-key (kbd "s-r l 3") #'(lambda () (interactive) (helm-ghostel-vrl-run-auto-function "jicai-prod")))
(global-set-key (kbd "s-r l 4") #'(lambda () (interactive) (helm-ghostel-vrl-run-auto-function "cc-devb-admin")))
(global-set-key (kbd "s-r l 5") #'(lambda () (interactive) (helm-ghostel-vrl-run-auto-function "cc-devb-task")))
(global-set-key (kbd "s-r l 6") #'(lambda () (interactive) (helm-ghostel-vrl-run-auto-function "cc-devb-open")))
(global-set-key (kbd "s-r l 9") #'(lambda () (interactive) (helm-ghostel-vrl-run-auto-function "rlon-devb-admin")))
(global-set-key (kbd "s-r l 0") #'(lambda () (interactive) (helm-ghostel-vrl-run-auto-function "rlon-devb-task")))
...
(global-set-key (kbd "s-r s-r gb") #'(lambda () (interactive) (let* ((ghostel-kill-buffer-on-exit nil)
                                                                     (root (projectile-project-root))
                                                                     (root-base-name (car (last (split-string root "/" t))))
                                                                     (buffer-name (format "*ghostel-cmd-git-multi-branch-%s*" root-base-name)))
                                                                (lx/run-in-ghostel "git multi-branch" buffer-name root t))))
(global-set-key (kbd "s-r s-r gl") #'(lambda () (interactive) (let* ((ghostel-kill-buffer-on-exit nil)
                                                                    (root (projectile-project-root))
                                                                    (root-base-name (car (last (split-string root "/" t))))
                                                                    (buffer-name (format "*ghostel-cmd-git-multi-pull-%s*" root-base-name)))
                                                                (lx/run-in-ghostel "git multi-pull" buffer-name root t))))
(global-set-key (kbd "s-r s-r ga") #'(lambda (arg) (interactive "P") (let* ((ghostel-kill-buffer-on-exit nil)
