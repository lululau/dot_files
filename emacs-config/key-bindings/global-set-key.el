...
(global-set-key (kbd "s-r q") #'(lambda () (interactive)
                                  (if (bound-and-true-p arql-env)
                                      (lx/run-in-pry-vterm (format "~/.rvm/gems/default/bin/arql -e %s" arql-env) (format "*arql-%s*" arql-env) (projectile-project-root))
                                    (lx/run-in-pry-vterm "~/.rvm/gems/default/bin/arql -e lcldevb" "*arql-lcldevb*" (projectile-project-root) t))))
...
(global-set-key (kbd "s-r 1") #'(lambda () (interactive) (helm-zsh-vterm-ssh-run "jicai.prod1")))
(global-set-key (kbd "s-r 2") #'(lambda () (interactive) (helm-zsh-vterm-ssh-run "jicai.prod2")))
(global-set-key (kbd "s-r 3") #'(lambda () (interactive) (helm-zsh-vterm-ssh-run "jicai.prod3")))
(global-set-key (kbd "s-r 8") #'(lambda () (interactive) (helm-zsh-vterm-ssh-run "jicai.uat")))
(global-set-key (kbd "s-r 9") #'(lambda () (interactive) (helm-zsh-vterm-ssh-run "jicai.dev")))
...
(global-set-key (kbd "s-r l 9") #'(lambda () (interactive) (helm-vterm-vrl-run-auto-function "rlon-devb-admin")))
(global-set-key (kbd "s-r l 0") #'(lambda () (interactive) (helm-vterm-vrl-run-auto-function "rlon-devb-task")))
