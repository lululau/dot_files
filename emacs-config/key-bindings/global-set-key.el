...
(global-set-key (kbd "s-r q") #'(lambda () (interactive)
                                  (if (bound-and-true-p arql-env)
                                    ...
                                    (lx/run-in-vterm "~/.rvm/gems/ruby-2.7.0/bin/arql -e lcldevb" "*arql-lcldevb*"))))
...
(global-set-key (kbd "s-r s-l 1") #'(lambda () (interactive) (lx/run-in-vterm "~/bin/vrl lcl-devb-admin" "*vterm-vrl-lcl-devb*" nil t)))
(global-set-key (kbd "s-r s-l 2") #'(lambda () (interactive) (lx/run-in-vterm "~/bin/vrl md-dev-admin" "*vterm-vrl-md-dev*" nil t)))
