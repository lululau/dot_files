...
(global-set-key (kbd "s-r 0") #'(lambda () (interactive) (let ((process-environment '("SSH_INTERACTIVE=1"))) (lx/run-in-zsh-vterm "ssh lx.kt" "*vterm-ssh-lx.kt*" nil t))))
(global-set-key (kbd "s-r 1") #'(lambda () (interactive) (let ((process-environment '("SSH_INTERACTIVE=1"))) (lx/run-in-zsh-vterm "ssh lcl.devb" "*vterm-ssh-lcl.devb*" nil t))))
(global-set-key (kbd "s-r 2") #'(lambda () (interactive) (let ((process-environment '("SSH_INTERACTIVE=1"))) (lx/run-in-zsh-vterm "ssh ceres.devb" "*vterm-ssh-ceres.devb*" nil t))))
(global-set-key (kbd "s-r 3") #'(lambda () (interactive) (let ((process-environment '("SSH_INTERACTIVE=1"))) (lx/run-in-zsh-vterm "ssh lcl.pro1" "*vterm-ssh-lcl.pro1*" nil t))))
(global-set-key (kbd "s-r 4") #'(lambda () (interactive) (let ((process-environment '("SSH_INTERACTIVE=1"))) (lx/run-in-zsh-vterm "ssh lcl.pro2" "*vterm-ssh-lcl.pro2*" nil t))))
(global-set-key (kbd "s-r 5") #'(lambda () (interactive) (let ((process-environment '("SSH_INTERACTIVE=1"))) (lx/run-in-zsh-vterm "ssh lcl.pro3" "*vterm-ssh-lcl.pro3*" nil t))))
