...
(global-set-key (kbd "s-r l 1") #'(lambda () (interactive) (helm-vterm-vrl-run-auto-function "wj-devb-admin")))
...
(global-set-key (kbd "s-r l 0") #'(lambda () (interactive) (helm-vterm-vrl-run-auto-function "rlon-devb-server")))
