...
(global-set-key (kbd "s-r q") #'(lambda () (interactive)
                                  (if (bound-and-true-p arql-env)
                                      (lx/run-in-vterm (format "~/.rvm/gems/ruby-2.7.2/bin/arql -e %s" arql-env) (format "*arql-%s*" arql-env) (projectile-project-root))
                                    (lx/run-in-vterm "~/.rvm/gems/ruby-2.7.2/bin/arql -e lcldevb" "*arql-lcldevb*" (projectile-project-root) t))))
...
(global-set-key (kbd "s-r l 1") #'(lambda () (interactive) (lx/run-in-vterm "~/bin/vrl lcl-devb-admin -a" "*vterm-vrl-lcl-devb*" nil t)))
(global-set-key (kbd "s-r l 2") #'(lambda () (interactive) (lx/run-in-vterm "~/bin/vrl md-dev-admin -a" "*vterm-vrl-md-dev*" nil t)))
...
(global-set-key (kbd "s-r p 0") #'(lambda () (interactive) (lx/run-in-vterm "~/.rvm/gems/ruby-2.7.2/bin/prize -h 127.0.0.1 -d 0" "*vterm-prize-localhost*" nil t)))
(global-set-key (kbd "s-r p 1") #'(lambda () (interactive) (lx/run-in-vterm "~/.rvm/gems/ruby-2.7.2/bin/prize -h 39.97.213.239 -d 0" "*vterm-prize-lcl-devb*" nil t)))
(global-set-key (kbd "s-r p 2") #'(lambda () (interactive) (lx/run-in-vterm "~/.rvm/gems/ruby-2.7.2/bin/prize -h 39.97.213.239 -d 1" "*vterm-prize-md-dev*" nil t)))
