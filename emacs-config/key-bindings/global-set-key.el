...
(global-set-key (kbd "s-r 1") #'(lambda () (interactive) (helm-zsh-vterm-ssh-run "lx16")))
(global-set-key (kbd "s-r 2") #'(lambda () (interactive) (helm-zsh-vterm-ssh-run "dev42")))
(global-set-key (kbd "s-r 3") #'(lambda () (interactive) (helm-zsh-vterm-ssh-run "jicai.devb")))
...
(global-set-key (kbd "s-r l 2") #'(lambda () (interactive) (helm-vterm-vrl-run-auto-function "wj-devb-server")))
