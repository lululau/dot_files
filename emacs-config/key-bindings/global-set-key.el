...
(global-set-key (kbd "s-r s-c bU") #'(lambda () (interactive) (let ((vterm-kill-buffer-on-exit nil)) (lx/run-in-vterm "brew upgrade && brew post-update && brew cleanup" "*vterm-cmd-brew-upgrade-cleanup*" nil t))))
