...
(setq lx/dirs '(("odA" applications-dir "/Applications/")
                ("odb" bin-dir "~/bin/")
                ("odC" cafe-dir "~/Cafe/")
                ("odc" cascode-dir "~/.config/")
                ("odd" downloads-dir "~/Downloads/")
                ("odD" documents-dir "~/Documents/")
                ("odf" documents-dir "~/.fzf/")
                ("odg" github-dir "~/cascode/github.com/")
                ("odH" user-dir "/home")
                ("odh" home-dir "~/")
                ("odi" images-dir "~/Library/Mobile Documents/com~apple~CloudDocs/")
                ("odk" kt-dir "~/kt/")
                ("odl" images-dir "~/Library/Application Support/")
                ("odL" images-dir "~/Library/Preferences/")
                ("odm" movies-dir "~/Movies/")
                ("ods" scratch-dir "~/Documents/scratches/")
                ("odS" snips-dir "~/snips/")
                ("ode" emacs-dir "~/.emacs.d/")
                ("odz" emacs-dir "~/.spacezsh/")
                ("odZ" emacs-dir "~/.oh-my-zsh/")
                ("od/" root-dir "/")
                ("odv" volumes-dir "/Volumes")
                ("odT" volumes-dir "~/.tmux")
                ("odt" tmp-dir "~/tmp/")))
