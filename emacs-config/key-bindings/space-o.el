  ...
  (helm :prompt "Remote locations: "
        ...
        (list (helm-build-sync-source "Remote locations"
                ...
                :candidates  (list (cons (format "%-20s%s" "lx.sd" "~") "/rpc:lx.sd:~/")
                                   ...
                                   (cons (format "%-20s%s" "jicai.dev" "/etc/nginx/conf.d") "/rpc:jicai.dev:/etc/nginx/conf.d")
                                   (cons (format "%-20s%s" "jicai.uat" "/data") "/rpc:jicai.uat:/data")
                                   (cons (format "%-20s%s" "jicai.uat" "/etc/nginx/conf.d") "/rpc:jicai.uat:/etc/nginx/conf.d")
                                   (cons (format "%-20s%s" "jicai.uat" "openvpn ccd") "/rpc:jicai.uat:/data/openvpn/openvpn-admin/openvpn/ccd")
                                   (cons (format "%-20s%s" "ubuntu.sd" "/data") "/rpc:ubuntu.sd:/data")
                                   (cons (format "%-20s%s" "ubuntu.sd" "openclaw workspace") "/rpc:ubuntu.sd:/data/copaw/workspaces/default")
                                   (cons (format "%-20s%s" "ubuntu.sd" "openclaw envs.json") "/rpc:ubuntu.sd:/data/.copaw.secret")
                                   (cons (format "%-20s%s" "jicai.prod1" "/data") "/rpc:jicai.prod1:/data")
                                   (cons (format "%-20s%s" "jicai.prod1" "/etc/nginx/conf.d") "/rpc:jicai.prod1:/etc/nginx/conf.d")
                                   (cons (format "%-20s%s" "jicai.prod2" "/data") "/rpc:jicai.prod2:/data")
                                   ...
                                   ;; (cons (format "%-20s%s" "ll.devb" "/etc/nginx/conf.d") "/rpc:ll.devb:/etc/nginx/conf.d")
                                   ;; (cons (format "%-20s%s" "md.dev" "/etc/nginx/conf.d") "/rpc:md.dev:/etc/nginx/conf.d")
                                   ;; (cons (format "%-20s%s" "lcl.fe1" "/etc/nginx/conf.d") "/rpc:lcl.fe1:/etc/nginx/conf.d")
                                   ;; (cons (format "%-20s%s" "lcl.fe2" "/etc/nginx/conf.d") "/rpc:lcl.fe2:/etc/nginx/conf.d")
                                   ;; (cons (format "%-20s%s" "ceres.fe1" "/opt/nginx/conf/conf.d") "/rpc:ceres.fe1:/opt/nginx/conf/conf.d")
                                   ;; (cons (format "%-20s%s" "ceres.fe2" "/opt/nginx/conf/conf.d") "/rpc:ceres.fe2:/opt/nginx/conf/conf.d")
                                   ;; (cons (format "%-20s%s" "jenkins2" "/data/jenkins_home/workspace/docker_file") "/rpc:jenkins2:/data/jenkins_home/workspace/docker_file")
                                   ;; (cons (format "%-20s%s" "jenkins2" "/data/jenkins_home/workspace") "/rpc:jenkins2:/data/jenkins_home/workspace")
                                   ;; (cons (format "%-20s%s" "ceres.api1" "~/") "/rpc:ceres.api1:~/")
                                   ;; (cons (format "%-20s%s" "ceres.api2" "~/") "/rpc:ceres.api2:~/")
                                   ;; (cons (format "%-20s%s" "ceres.job1" "~/") "/rpc:ceres.job1:~/")
                                   ;; (cons (format "%-20s%s" "ceres.job2" "~/") "/rpc:ceres.job2:~/")
                                   ;; (cons (format "%-20s%s" "ceres.job3" "~/") "/rpc:ceres.job3:~/")
                                   ;; (cons (format "%-20s%s" "ceres.mq" "~/") "/rpc:ceres.mq:~/")
                                   ;; (cons (format "%-20s%s" "elk2" "~/") "/rpc:elk2:~/")
                                   ;; (cons (format "%-20s%s" "gitlab.ktjr" "~/") "/rpc:gitlab.ktjr:~/")
                                   ;; (cons (format "%-20s%s" "jira" "~/") "/rpc:jira:~/")
                                   ;; (cons (format "%-20s%s" "kapi1" "~/") "/rpc:kapi1:~/")
                                   ;; (cons (format "%-20s%s" "kapi2" "~/") "/rpc:kapi2:~/")
                                   ;; (cons (format "%-20s%s" "kapi3" "~/") "/rpc:kapi3:~/")
                                   ;; (cons (format "%-20s%s" "khcpro" "~/") "/rpc:khcpro:~/")
                                   ;; (cons (format "%-20s%s" "kt01" "/etc/nginx/sites-enabled") "/rpc:kt01:/etc/nginx/sites-enabled")
                                   ;; (cons (format "%-20s%s" "kt02" "/etc/nginx/sites-enabled") "/rpc:kt02:/etc/nginx/sites-enabled")
                                   ;; (cons (format "%-20s%s" "kt03" "/etc/nginx/sites-enabled") "/rpc:kt03:/etc/nginx/sites-enabled")
                                   ;; (cons (format "%-20s%s" "kt04" "/etc/nginx/sites-enabled") "/rpc:kt04:/etc/nginx/sites-enabled")
                                   ;; (cons (format "%-20s%s" "kt05" "/etc/nginx/sites-enabled") "/rpc:kt05:/etc/nginx/sites-enabled")
                                   ;; (cons (format "%-20s%s" "root@kt01" "/etc/nginx/sites-enabled") "/rpc:root@kt01:/etc/nginx/sites-enabled")
                                   ;; (cons (format "%-20s%s" "root@kt02" "/etc/nginx/sites-enabled") "/rpc:root@kt02:/etc/nginx/sites-enabled")
                                   ;; (cons (format "%-20s%s" "root@kt03" "/etc/nginx/sites-enabled") "/rpc:root@kt03:/etc/nginx/sites-enabled")
                                   ;; (cons (format "%-20s%s" "root@kt04" "/etc/nginx/sites-enabled") "/rpc:root@kt04:/etc/nginx/sites-enabled")
                                   ;; (cons (format "%-20s%s" "root@kt05" "/etc/nginx/sites-enabled") "/rpc:root@kt05:/etc/nginx/sites-enabled")
                                   ;; (cons (format "%-20s%s" "lcl.api1" "~/") "/rpc:lcl.api1:~/")
                                   ;; (cons (format "%-20s%s" "lcl.api2_task" "~/") "/rpc:lcl.api2_task:~/")
                                   ;; (cons (format "%-20s%s" "lcl.pro1" "~/") "/rpc:lcl.pro1:~/")
                                   ;; (cons (format "%-20s%s" "lcl.pro2" "~/") "/rpc:lcl.pro2:~/")
                                   ;; (cons (format "%-20s%s" "lcl.pro3" "~/") "/rpc:lcl.pro3:~/")
                                   ;; (cons (format "%-20s%s" "mw" "~/") "/rpc:mw:~/")
                                   ;; (cons (format "%-20s%s" "nexus" "~/") "/rpc:nexus:~/")
                                   ;; (cons (format "%-20s%s" "R720" "/data") "/rpc:R720:/data")
                                   ;; (cons (format "%-20s%s" "R730" "/data") "/rpc:R730:/data")
                                   ;; (cons (format "%-20s%s" "repair.pro" "~/") "/rpc:repair.pro:~/")
                                   ;; (cons (format "%-20s%s" "seafile" "~/") "/rpc:seafile:~/")
                                   )
                :action  'find-file
                ))))
