(advice-add 'create-spacemacs-theme :override
            (lambda (variant theme-name)
              (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
                        ...
                        (cblk-bg       (if (eq variant 'dark) (if (true-color-p) "#2f2b33" "#303030") (if (true-color-p) "#e8e3f0" "#ffffff")))
                        ...
                        (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#292e34" "#303030") (if (true-color-p) "#ecf3ec" "#ffffff")))
                        ...
                        (head1-bg      (if (eq variant 'dark) (if (true-color-p) "#293239" "#303030") (if (true-color-p) "#edf1ed" "#ffffff")))
                        (head2         (if (eq variant 'dark) (if (true-color-p) "#2d9574" "#2aa198") (if (true-color-p) "#2d9574" "#2aa198")))
                        (head2-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "#303030") (if (true-color-p) "#edf2e9" "#ffffff")))
                        (head3         (if (eq variant 'dark) (if (true-color-p) "#67b11d" "#67b11d") (if (true-color-p) "#67b11d" "#5faf00")))
                        (head3-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "#303030") (if (true-color-p) "#edf2e9" "#ffffff")))
                        (head4         (if (eq variant 'dark) (if (true-color-p) "#b1951d" "#875f00") (if (true-color-p) "#b1951d" "#875f00")))
                        (head4-bg      (if (eq variant 'dark) (if (true-color-p) "#32322c" "#303030") (if (true-color-p) "#f6f1e1" "#ffffff")))
                        ...
                        (aqua-bg       (if (eq variant 'dark) (if (true-color-p) "#293235" "#303030") (if (true-color-p) "#edf2e9" "#ffffff")))
                        (green         (if (eq variant 'dark) (if (true-color-p) "#67b11d" "#67b11d") (if (true-color-p) "#67b11d" "#5faf00")))
                        (green-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "#303030") (if (true-color-p) "#edf2e9" "#ffffff")))
                        (green-bg-s    (if (eq variant 'dark) (if (true-color-p) "#29422d" "#303030") (if (true-color-p) "#dae6d0" "#ffffff")))
                        ...
                        (red-bg        (if (eq variant 'dark) (if (true-color-p) "#3c2a2c" "#303030") (if (true-color-p) "#faede4" "#ffffff")))
                        (red-bg-s      (if (eq variant 'dark) (if (true-color-p) "#512e31" "#303030") (if (true-color-p) "#eed9d2" "#ffffff")))
                        (blue          (if (eq variant 'dark) (if (true-color-p) "#4f97d7" "#268bd2") (if (true-color-p) "#3a81c3" "#268bd2")))
                        (blue-bg       (if (eq variant 'dark) (if (true-color-p) "#293239" "#303030") (if (true-color-p) "#edf1ed" "#d7d7ff")))
