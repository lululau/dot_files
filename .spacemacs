...
before layers configuration."
  ...
  (defun spacemacs/set-state-faces()
    (when (string= "spacemacs-dark" spacemacs--cur-theme)
       ...
       (face-spec-set 'spacemacs-emacs-face '((t (:background "SkyBlue2" :foreground "#222226" :box (:line-width 1 :color "#5d4d7a") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-evilified-face '((t (:background "LightGoldenrod3" :foreground "#222226" :box (:line-width 1 :color "#5d4d7a") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-helm-navigation-ms-face '((t :background "#e0211d" :foreground "black")))
       (face-spec-set 'spacemacs-hybrid-face '((t (:background "SkyBlue2" :foreground "#222226" :box (:line-width 1 :color "#5d4d7a") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-ido-navigation-ms-face '((t :background "#e0211d" :foreground "black" :weight bold)))
       (face-spec-set 'spacemacs-iedit-face '((t (:background "firebrick1" :foreground "#222226" :box (:line-width 1 :color "#5d4d7a") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-iedit-insert-face '((t (:background "firebrick1" :foreground "#222226" :box (:line-width 1 :color "#5d4d7a") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-insert-face '((t (:background "chartreuse3" :foreground "#222226" :box (:line-width 1 :color "#5d4d7a") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-lisp-face '((t (:background "HotPink1" :foreground "#222226" :box (:line-width 1 :color "#5d4d7a") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-motion-face '((t (:background "plum3" :foreground "#222226" :box (:line-width 1 :color "#5d4d7a") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-normal-face '((t (:background "DarkGoldenrod2" :foreground "#222226" :box (:line-width 1 :color "#5d4d7a") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-replace-face '((t (:background "chocolate" :foreground "#222226" :box (:line-width 1 :color "#5d4d7a") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-visual-face '((t (:background "gray" :foreground "#222226" :box (:line-width 1 :color "#5d4d7a") :inherit (quote mode-line)))))
    ...
    (when (string= "solarized-light" spacemacs--cur-theme)
       ...
       (face-spec-set 'spacemacs-emacs-face '((t (:background "SkyBlue2" :foreground "#eee8d5" :box (:line-width 1 :color "#657b83") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-evilified-face '((t (:background "LightGoldenrod3" :foreground "#eee8d5" :box (:line-width 1 :color "#657b83") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-helm-navigation-ms-face '((t :background "#cb4b16" :foreground "black")))
       (face-spec-set 'spacemacs-hybrid-face '((t (:background "SkyBlue2" :foreground "#eee8d5" :box (:line-width 1 :color "#657b83") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-ido-navigation-ms-face '((t :background "#cb4b16" :foreground "black" :weight bold)))
       (face-spec-set 'spacemacs-iedit-face '((t (:background "firebrick1" :foreground "#eee8d5" :box (:line-width 1 :color "#657b83") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-iedit-insert-face '((t (:background "firebrick1" :foreground "#eee8d5" :box (:line-width 1 :color "#657b83") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-insert-face '((t (:background "chartreuse3" :foreground "#eee8d5" :box (:line-width 1 :color "#657b83") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-lisp-face '((t (:background "HotPink1" :foreground "#eee8d5" :box (:line-width 1 :color "#657b83") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-motion-face '((t (:background "plum3" :foreground "#eee8d5" :box (:line-width 1 :color "#657b83") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-normal-face '((t (:background "DarkGoldenrod2" :foreground "#eee8d5" :box (:line-width 1 :color "#657b83") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-replace-face '((t (:background "chocolate" :foreground "#eee8d5" :box (:line-width 1 :color "#657b83") :inherit (quote mode-line)))))
       (face-spec-set 'spacemacs-visual-face '((t (:background "gray" :foreground "#eee8d5" :box (:line-width 1 :color "#657b83") :inherit (quote mode-line)))))
       (face-spec-set 'diff-hl-change '((t (:background "#69B7F0" :foreground "#00629D"))))
       (face-spec-set 'diff-hl-delete '((t (:background "#FF6E64" :foreground "#990A1B"))))
       (face-spec-set 'diff-hl-insert '((t (:background "#B4C342" :foreground "#546E00"))))
       )
