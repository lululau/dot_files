...
alias mdui=ekphos
alias oc=opencode
alias claude!="clear; DISABLE_INSTALLATION_CHECKS=1 ANTHROPIC_BASE_URL=https://open.bigmodel.cn/api/anthropic ANTHROPIC_MODEL='glm-5.3[1m]' ANTHROPIC_DEFAULT_OPUS_MODEL='glm-5.3[1m]' ANTHROPIC_DEFAULT_SONNET_MODEL=glm-5-turbo ANTHROPIC_DEFAULT_HAIKU_MODEL=glm-4.7 ANTHROPIC_AUTH_TOKEN=$ZHIPU_API_KEY claude --dangerously-skip-permissions"
alias zai!="clear; DISABLE_INSTALLATION_CHECKS=1 ANTHROPIC_BASE_URL=https://open.bigmodel.cn/api/anthropic ANTHROPIC_MODEL='glm-5.3[1m]' ANTHROPIC_DEFAULT_OPUS_MODEL='glm-5.3[1m]' ANTHROPIC_DEFAULT_SONNET_MODEL=glm-5-turbo ANTHROPIC_DEFAULT_HAIKU_MODEL=glm-4.7 ANTHROPIC_AUTH_TOKEN=$ZHIPU_API_KEY claude --dangerously-skip-permissions"
