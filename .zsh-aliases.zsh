...
alias mdui=ekphos
alias oc=opencode
alias claude!="clear; DISABLE_INSTALLATION_CHECKS=1 ANTHROPIC_BASE_URL=https://open.bigmodel.cn/api/anthropic ANTHROPIC_MODEL='glm-5.3-flash[1m]' ANTHROPIC_DEFAULT_OPUS_MODEL='glm-5.3-flash[1m]' ANTHROPIC_DEFAULT_SONNET_MODEL=glm-5.3-flash[1m] ANTHROPIC_DEFAULT_HAIKU_MODEL=glm-5.3-flash[1m] ANTHROPIC_AUTH_TOKEN=$ZHIPU_API_KEY claude --dangerously-skip-permissions"
alias zai!="clear; DISABLE_INSTALLATION_CHECKS=1 ANTHROPIC_BASE_URL=https://open.bigmodel.cn/api/anthropic ANTHROPIC_MODEL='glm-5.3-flash[1m]' ANTHROPIC_DEFAULT_OPUS_MODEL='glm-5.3-flash[1m]' ANTHROPIC_DEFAULT_SONNET_MODEL=glm-5.3-flash[1m] ANTHROPIC_DEFAULT_HAIKU_MODEL=glm-5.3-flash[1m] ANTHROPIC_AUTH_TOKEN=$ZHIPU_API_KEY claude --dangerously-skip-permissions"
...
alias deepseek!="clear; DISABLE_INSTALLATION_CHECKS=1 ANTHROPIC_BASE_URL=https://api.deepseek.com/anthropic ANTHROPIC_MODEL='deepseek-flash[1m]' ANTHROPIC_DEFAULT_OPUS_MODEL='deepseek-flash[1m]' ANTHROPIC_DEFAULT_SONNET_MODEL='deepseek-flash[1m]' ANTHROPIC_DEFAULT_HAIKU_MODEL='deepseek-flash[1m]' ANTHROPIC_AUTH_TOKEN=$DEEPSEEK_API_KEY claude --dangerously-skip-permissions"
