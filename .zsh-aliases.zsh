...
alias deepseek!="clear; DISABLE_INSTALLATION_CHECKS=1 ANTHROPIC_BASE_URL=https://api.deepseek.com/anthropic ANTHROPIC_MODEL='deepseek-v4-flash[1m]' ANTHROPIC_DEFAULT_OPUS_MODEL='deepseek-v4-flash[1m]' ANTHROPIC_DEFAULT_SONNET_MODEL='deepseek-v4-flash[1m]' ANTHROPIC_DEFAULT_HAIKU_MODEL='deepseek-v4-flash[1m]' ANTHROPIC_AUTH_TOKEN=$DEEPSEEK_API_KEY claude --dangerously-skip-permissions"
